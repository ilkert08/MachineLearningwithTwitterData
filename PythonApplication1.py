...
def stopWordsRemoval():
    ...
    file1 = open("C:/Users/user0/Desktop/FilteredText/nonfiltered55.txt", "r") 
    t = 0
...
def wordSteaming():
    ...
    from nltk.tokenize import word_tokenize 
    print("giris!")
    file1 = open("C:/Users/user0/Desktop/FilteredText/lastfilter.txt")
    ps = PorterStemmer() 
    t = 0
    ...
    for t in range(200000):
        ...
        for r in words5:
            ...
            for w in words: 
                featureFile = open("C:/Users/user0/Desktop/FilteredText/features.txt","a")
...
def uniqueWords():
    file1 = open("C:/Users/user0/Desktop/FilteredText/sonhal/highFreqList.txt")
    reader = file1.read()
    splt0 = reader.split()
    print(len(reader))
...
#                    c = c + 1
#            if c > 10:
#                file2 = open("C:/Users/user0/Desktop/FilteredText/highFreq.txt","a")
#                print(w+":"+str(c))
#                low = low + 1
#                print("High:"+ str(low))
#                file2.write(w+" ")
...
#    print("LOW FREQ:" + str(low))   
    ...
    for i in range (60001):
        ...
        ss = ""
        file2 = open("C:/Users/user0/Desktop/FilteredText/sonhal/sonsayilar.txt","a")    
...
def highFreqList():
    file1 = open('C:/Users/user0/Desktop/FilteredText/otuzbinsozcuk.txt', 'rt')
    file2 = open('C:/Users/user0/Desktop/FilteredText/highFreq.txt', 'rt')
    ...
    for i in range(0, 60001):
        ...
        for w in splt1:
            for w2 in splt2:
                if w == w2:
                    ss = ss + " " + w
        file3 = open('C:/Users/user0/Desktop/FilteredText/sonhal/highFreqList.txt', 'a')
        file3.write(ss)
        file3.write("\n")
        file3.close()
...
def dataStabilizer():
    ...
    file_input = open('C:/Users/user0/Desktop/FilteredText/sonhal/sonsayilar.txt', 'rt')
...
def kNN ():
    ...
    text_file = open("C:/Users/user0/Documents/NetBeansProjects/bilgiyeErisim1/info.txt", "a+")
...
def decisionTree():
    ...
    dataStabilizer()
    print("Gecti!")
    file_input = open('C:/Users/user0/Desktop/train_edit33.csv', 'rt')
...
#uniqueWords()
    #le.fit(["i am so happy today", "i am so sad today", "i am so happy and funny"])
    #print(le.transform(["i am so happy today", "i am so sad today", "i am so happy and funny"]))
file00 = open('C:/Users/user0/Documents/NetBeansProjects/bilgiyeErisim1/pythonVariables.txt', 'rt')
ss = file00.readline()
